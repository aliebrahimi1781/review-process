...
import md.endava.oe.service.UserService;
...
public class ActivitiUserManager extends UserEntityManager {
    ...
    public User findUserById(final String userId) {
        final md.endava.oe.domain.User pmUser = userService.findById(Long.parseLong(userId));
    ...
    public List<Group> findGroupsByUser(final String userId) {
        md.endava.oe.domain.User pmUser = userService.findById(Long.parseLong(userId));
    ...
    private UserEntity pmUserToActivitiUser(md.endava.oe.domain.User user) {
